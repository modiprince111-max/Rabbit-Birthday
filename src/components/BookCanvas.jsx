...
const birthdayMessage = [
    "First of all, before you start overthinking anything — yes this is going to be long, and no you are not allowed to complain because you created this essay tradition yourself 😌",
    ...
    "You’re not a “happy birthday, stay blessed” kind of person in my life.",
    ...
    "And somewhere between all our random conversations, arguments, sarcasm, mood swings, roasting sessions, and those unexpectedly deep talks… you became someone extremely important to me.",
    ...
    "So yeah,",
    "Happy Birthday to my favorite human, favorite headache, favorite comfort person and favorite overthinker 💗🐇",
    ...
    "Now go enjoy your day properly and don’t forget —",
    "— Prince",
...
const BookCanvas = ({ active, setActive }) => {
    ...
    return (
        <div className={`boxMail ${active ? 'hidden opacity-0 pointer-events-none' : 'opacity-100 visible'}`}>
            <audio ref={audioRef} src={teraHoGaya} preload="auto" />
            ...
            <div ref={dropdownRef} className={`boxMail-container duration-500 -translate-y-1/2 ${active ? 'top-0' : ' top-1/2'}`}>
                ...
                <div className="card2">
                    <div className="card2-content">
                        ...
                        <div className="card2-message-text">
                            {birthdayMessage.map((paragraph, index) => (
