...
const HeartTransition = () => {
    return (
        <div className="route-loader route-loader--intro" aria-hidden="true">
            <main className="bg-[#8b0000] HeartTransisitonOpen">
                <svg className="heart-loader" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 90 90" version="1.1">
